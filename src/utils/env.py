...
GCP_APP_ENDPOINT: str = getenv("GCP_APP_ENDPOINT")          # type: ignore
PORT: int = int(getenv("PORT", "8080"))                     # Set by Docker.
PROD_BOT_TOKEN: str = getenv("PROD_BOT_TOKEN")              # type: ignore
TEST_BOT_TOKEN: str = getenv("TEST_BOT_TOKEN")              # type: ignore
